...
public class FastDFSTest {
	...
	public static void upload() throws Exception {
		String filePath = "/Users/PC/Desktop/pay/edu-demo-fdfs/edu-demo-fdfs/TestFile/DubboVideo.jpg";
		File file = new File(filePath);
		String fileId = FastDFSClient.uploadFile(file, filePath);
		System.out.println("Upload local file " + filePath + " ok, fileid=" + fileId);
		// fileId:	group1/M00/00/00/wKgBblkN1QSAMtVuAAP3btxj__E620.jpg
	...
	public static void download() throws Exception {
		String fileId = "group1/M00/00/00/wKgBblkN1QSAMtVuAAP3btxj__E620.jpg";
		InputStream inputStream = FastDFSClient.downloadFile(fileId);
		File destFile = new File("/Users/PC/Desktop/pay/edu-demo-fdfs/edu-demo-fdfs/TestFile/DownloadTest.jpg");
